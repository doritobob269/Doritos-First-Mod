...
public class EntityDoritobob extends EntityAnimal {
//extends EntityAnimal{
	...
	public EntityDoritobob(World world){
        super(world);
	...
	{
		this.setTextureType(RenderDoritobob.textureLocation);
	}
    ...
    public EntityDoritobob(World world, double x, double y, double z){
        this(world);
        setPosition(x, y, z);
    }
    ...
    @Override
    public EntityDoritobob createChild(EntityAgeable entity) {
        //return null;
        return new EntityDoritobob(worldObj);
    }
