        ...
        if (movingobjectposition == null){
            ...
            if (flag){
                ...
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK){
                    ...
                    EntityEntityTest bear = new EntityEntityTest(world, i + 0.5, j + 1.0F,k + 0.5);
 
                    if (!world.getCollidingBoundingBoxes(bear, bear.boundingBox.expand(-0.1D, -0.1D, -0.1D)).isEmpty()){
                        return itemStack;
                    }
 
                    if (!world.isRemote){
                        world.spawnEntityInWorld(bear);
                    }
